        ...
        <tbody>
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <?php if($item->status_survey == 'Belum disurvey'): ?>
                            <span
                                class="text-xs font-weight-bold "style="background-color:#e06666"><?php echo e($item->status_survey); ?></span>
                        <?php endif; ?>

                        <?php if($item->status_survey == 'Sudah disurvey'): ?>
                            <span
                                class="text-xs font-weight-bold "style="background-color:#80ca5e"><?php echo e($item->status_survey); ?></span>
                        <?php endif; ?>
                    </td>
...
<?php /**PATH D:\AKADEMIK\SKRIPSI 2022\Aplikasi_pendataan_kemiskinan\Pendataan_kemiskinan\resources\views/penduduk/read.blade.php ENDPATH**/ ?>