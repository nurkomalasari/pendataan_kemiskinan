...
<div class="p-2">
    <div class="form-group">
        ...
        <select class="form-select" id="id_penduduk" name="id_penduduk" required>
            <option value="<?php echo e($data->id); ?>"><?php echo e($data->penduduk->nama); ?></option>
...
<?php /**PATH D:\AKADEMIK\SKRIPSI 2022\Pendataan_kemiskinan\Pendataan_kemiskinan\resources\views/hasilsurvey/edit.blade.php ENDPATH**/ ?>