    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a class=" nav-link {{ request()->is('pertanyaan/index') ? ' active' : '' }}" href="
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('clustering') ? 'active' : '' }}"
                        href="{{ url('clustering') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('hasil/index') ? ' active' : '' }} "
                        href="{{ url('hasil/index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('surveyor/index') ? ' active' : '' }} "
                        ...
                        <span class="nav-link-text ms-1">Data Surveyor</span>
                    </a>
                </li>
