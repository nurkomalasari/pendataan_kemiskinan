            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="/" class="logo">
                            <img src="{{ asset('LandingPage') }}/assets/images/logo-v1.png" alt="">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#services">Indikator Kemiskinan</a></li>
                                ...
                                <div class="col-lg-12">
                                    <div class="menu">
                                        <div class="first-thumb active">
                                            <div class="thumb">
                                                <span class="icon"><img
                                                        src="{{ asset('LandingPage') }}/assets/images/service-icon-01.png"
                                                        alt=""></span>
                                                Apartments
                                            </div>
                                        </div>
                                        <div>
                                            <div class="thumb">
                                                <span class="icon"><img
                                                        src="{{ asset('LandingPage') }}/assets/images/service-icon-02.png"
                                                        alt=""></span>
                                                Food &amp; Life
                                            </div>
                                        </div>
                                        <div>
                                            <div class="thumb">
                                                <span class="icon"><img
                                                        src="{{ asset('LandingPage') }}/assets/images/service-icon-03.png"
                                                        alt=""></span>
                                                Cars
                                            </div>
                                        </div>
                                        <div>
                                            <div class="thumb">
                                                <span class="icon"><img
                                                        src="{{ asset('LandingPage') }}/assets/images/service-icon-04.png"
                                                        alt=""></span>
                                                Shopping
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 align-self-center">
                                                            <div class="right-image">
                                                                <img src="{{ asset('LandingPage') }}/assets/images/services-image.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div>
                                                <div class="thumb">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 align-self-center">
                                                            <div class="right-image">
                                                                <img src="{{ asset('LandingPage') }}/assets/images/services-image-02.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div>
                                                <div class="thumb">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 align-self-center">
                                                            <div class="right-image">
                                                                <img src="{{ asset('LandingPage') }}/assets/images/services-image-03.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div>
                                                <div class="thumb">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 align-self-center">
                                                            <div class="right-image">
                                                                <img src="{{ asset('LandingPage') }}/assets/images/services-image-04.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="loop owl-carousel">
                        <div class="item">
                            <a href="#">
                                <div class="portfolio-item">
                                    <div class="thumb">
                                        <img src="{{ asset('LandingPage') }}/assets/images/portfolio-01.jpg"
                                            alt="">
                                    </div>
                        ...
                        <div class="item">
                            <a href="#">
                                <div class="portfolio-item">
                                    <div class="thumb">
                                        <img src="{{ asset('LandingPage') }}/assets/images/portfolio-02.jpg"
                                            alt="">
                                    </div>
                                    <div class="down-content">
                                        <h4>Website Builder</h4>
                        ...
                        <div class="item">
                            <a href="#">
                                <div class="portfolio-item">
                                    <div class="thumb">
                                        <img src="{{ asset('LandingPage') }}/assets/images/portfolio-03.jpg"
                                            alt="">
                                    </div>
                                    <div class="down-content">
                                        <h4>Website Builder</h4>
                        ...
                        <div class="item">
                            <a href="#">
                                <div class="portfolio-item">
                                    <div class="thumb">
                                        <img src="{{ asset('LandingPage') }}/assets/images/portfolio-04.jpg"
                                            alt="">
                                    </div>
                                    <div class="down-content">
                                        <h4>Website Builder</h4>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                    <div class="blog-post">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('LandingPage') }}/assets/images/blog-post-01.jpg"
                                    alt=""></a>
                        </div>
                        <div class="down-content">
                            ...
                            <span class="author"><img
                                    src="{{ asset('LandingPage') }}/assets/images/author-post.jpg"
                                    alt="">By: Andrea
                                Mentuzi</span>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="#"><img
                                                src="{{ asset('LandingPage') }}/assets/images/blog-post-02.jpg"
                                                alt=""></a>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="#"><img
                                                src="{{ asset('LandingPage') }}/assets/images/blog-post-03.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="right-content">
                                        <span class="category">SEO Analysis</span>
                            ...
                            <div class="col-lg-12">
                                <div class="post-item last-post-item">
                                    <div class="thumb">
                                        <a href="#"><img
                                                src="{{ asset('LandingPage') }}/assets/images/blog-post-04.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="right-content">
                                        <span class="category">SEO Analysis</span>
                                ...
                                <div class="fill-form">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="info-post">
                                                <div class="icon">
                                                    <img src="{{ asset('LandingPage') }}/assets/images/phone-icon.png"
                                                        alt="">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="info-post">
                                                <div class="icon">
                                                    <img src="{{ asset('LandingPage') }}/assets/images/email-icon.png"
                                                        alt="">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="info-post">
                                                <div class="icon">
                                                    <img src="{{ asset('LandingPage') }}/assets/images/location-icon.png"
                                                        alt="">
